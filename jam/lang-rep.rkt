...
(define predefined-metafunctions
  (list
   ...
   (metafunction
    'integer-<
    (mf:data 'integer_lt (pattern-of-ps (list integer-pattern integer-pattern))))
   (metafunction
    'real-=
    (mf:data 'real_equal (pattern-of-ps (list real-pattern real-pattern))))
   (metafunction
    'real-<
    (mf:data 'real_lt (pattern-of-ps (list real-pattern real-pattern))))

   (metafunction
    'integer-string
    (mf:data 'integer_string (pattern-of-ps (list integer-pattern))))
   (metafunction
    'real-string
    (mf:data 'real_string (pattern-of-ps (list real-pattern))))
